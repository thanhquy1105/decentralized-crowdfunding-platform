      ...
      <div className="projectContainer">
          ...
          <div className="projectInformationContainer">
            ...
            {!isOver && (
              <p className="afterRemainingDaysContainer">
                thời gian còn lại cho việc gây quỹ
              </p>
            )}
            {!isOver ? (!isOwner() && (
            ...
            ) : (projectDetails.refundClaimed[getContributorIndex()] ? (<h2 style={{ color: 'red' }}>Đã lấy hoàn trả!</h2>) : ''))}
            {modalShow && (
              <PaymentModal
        ...
        <div className="projectBottomContainer">
          ...
          <div className="projectLinkContainerWrapper">
            ...
            <div className="projectLinkContainer">
              <p className="projectLinkLabel">
                Danh mục: {getCategoryFromCode(projectDetails.category)}
              </p>
            </div>
            <div className="projectLinkContainer">
              <p className="projectLinkLabel">
                Ngày tạo: {displayDate(projectDetails.creationTime)}
              </p>
            </div>
          </div>
        </div>
        <div className="contributorHeader">Người đóng góp</div>
        <div className="contributors">
          <div className="tableRow header">
            <div className="item border" style={{width: "80px"}}>STT</div>
            <div className="item border">Địa chỉ</div>
            <div className="item border">Số lượng</div>
          </div>
